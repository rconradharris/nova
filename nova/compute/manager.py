...
class ComputeManager(manager.SchedulerDependentManager):
    ...
    def _cleanup_running_deleted_instances(self, context):
        ...
        """
        # NOTE(sirp): this cleanup task is a stop-gap solution until we can
        # figure out the root cause of why some instances remain running in
        # Xen even though they are flagged as deleted in the DB.
